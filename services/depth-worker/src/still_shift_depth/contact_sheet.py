"""Corpus preparation and source/depth contact-sheet rendering."""
...
from .preparation import DepthPreparationService, PreparationError
...
def build_contact_sheet(
    ...
    workspace_root: Path,
    output_path: Path,
    service: DepthPreparationService,
) -> dict[str, Any]:
