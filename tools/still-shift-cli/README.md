...
Create a UTF-8 JSONL file with one object per line. IDs must be unique ignoring case and use letters, digits, underscores, or hyphens (1–80 characters). Paths are resolved relative to the JSONL file. Blank lines are ignored.
