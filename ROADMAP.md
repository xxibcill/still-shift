...
- [ ] Preserve raw float depth for evaluation.
- [ ] Produce a normalized 8-bit depth texture for Phase 0 rendering.
- [ ] Apply percentile normalization and light edge-preserving smoothing.
- [ ] Validate dimensions, numeric range, NaNs, and corrupt outputs.
- [ ] Record device, inference time, memory where available, and cache status.
- [ ] Generate a depth contact sheet for the frozen corpus.
...
- [ ] Model and weight licenses/checksums are recorded.
- [ ] The v0.1 fake path remains green.
- [ ] Scene preparation reports version `0.2`.
